class DepthCam{
  ...
  void drawDepthImage(){
    //pushMatrix();
    // draw depthImageMap
    //image(context.depthImage(),0,0); //this is the depth image function
    image(context.userImage(),0,0,width,height); //this is the depth image + user coloring
  }
  ...
  PVector getCoM2d(PVector pos3d){
    PVector pos2d = new PVector();
    context.convertRealWorldToProjective(pos3d,pos2d);
    return pos2d;
  }
